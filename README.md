...
- [dompdf/dompdf](https://github.com/dompdf/dompdf) ([v2.0.8](https://github.com/dompdf/dompdf/releases/tag/v2.0.8), 2 days ago) - HTML to PDF converter for PHP
- [spatie/holidays](https://github.com/spatie/holidays) ([1.10.0](https://github.com/spatie/holidays/releases/tag/1.10.0), 2 days ago) - Calculate which days you don&#39;t have to work!
- [Jeroen-G/Explorer](https://github.com/Jeroen-G/Explorer) ([3.14.0](https://github.com/Jeroen-G/Explorer/releases/tag/3.14.0), 5 days ago) - 🗺️ Next-gen Elasticsearch driver for Laravel Scout.
...
- [spatie/db-dumper](https://github.com/spatie/db-dumper) ([3.6.0](https://github.com/spatie/db-dumper/releases/tag/3.6.0), 1 week ago) - Dump the contents of a database
