...
- [thecaliskan/laravel-stock](https://github.com/thecaliskan/laravel-stock) ([1.0.0](https://github.com/thecaliskan/laravel-stock/releases/tag/1.0.0), 4 days ago) - Laravel Stock, Forex, Crypto Data API
- [composer/ca-bundle](https://github.com/composer/ca-bundle) ([1.4.1](https://github.com/composer/ca-bundle/releases/tag/1.4.1), 6 days ago) - Lets you find a path to the system CA bundle, and includes a fallback to the Mozilla CA bundle.
