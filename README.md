...
- [Jeroen-G/Explorer](https://github.com/Jeroen-G/Explorer) ([3.13.0](https://github.com/Jeroen-G/Explorer/releases/tag/3.13.0), 2 days ago) - 🗺️ Next-gen Elasticsearch driver for Laravel Scout.
- [composer/ca-bundle](https://github.com/composer/ca-bundle) ([1.5.0](https://github.com/composer/ca-bundle/releases/tag/1.5.0), 3 days ago) - Lets you find a path to the system CA bundle, and includes a fallback to the Mozilla CA bundle.
- [spatie/php-structure-discoverer](https://github.com/spatie/php-structure-discoverer) ([2.1.1](https://github.com/spatie/php-structure-discoverer/releases/tag/2.1.1), 5 days ago) - Automatically discover classes within your PHP application
