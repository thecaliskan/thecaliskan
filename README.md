...
- [Laravel-Lang/lang](https://github.com/Laravel-Lang/lang) ([15.23.3](https://github.com/Laravel-Lang/lang/releases/tag/15.23.3), 4 days ago) - List of 127 languages for Laravel Framework, Laravel Jetstream, Laravel Fortify, Laravel Breeze, Laravel Cashier, Laravel Nova and Laravel UI.
...
- [php/pie](https://github.com/php/pie) ([1.1.0](https://github.com/php/pie/releases/tag/1.1.0), 3 weeks ago) - The PHP Installer for Extensions
- [php/php-src](https://github.com/php/php-src) ([php-8.3.24](https://github.com/php/php-src/releases/tag/php-8.3.24), 3 weeks ago) - The PHP Interpreter
- [symfony/http-foundation](https://github.com/symfony/http-foundation) ([v7.3.2](https://github.com/symfony/http-foundation/releases/tag/v7.3.2), 4 weeks ago) - Defines an object-oriented layer for the HTTP specification
