...
- [php/pie](https://github.com/php/pie) ([1.4.6](https://github.com/php/pie/releases/tag/1.4.6), 1 day ago) - 🥧 The PHP Installer for Extensions
- [spatie/dns](https://github.com/spatie/dns) ([2.8.1](https://github.com/spatie/dns/releases/tag/2.8.1), 2 days ago) - Retrieve DNS records
- [spatie/php-structure-discoverer](https://github.com/spatie/php-structure-discoverer) ([2.4.4](https://github.com/spatie/php-structure-discoverer/releases/tag/2.4.4), 3 days ago) - Automatically discover classes within your PHP application
- [spatie/crawler](https://github.com/spatie/crawler) ([9.3.2](https://github.com/spatie/crawler/releases/tag/9.3.2), 6 days ago) - https://spatie.be/docs/crawler
- [spatie/laravel-backup](https://github.com/spatie/laravel-backup) ([10.3.0](https://github.com/spatie/laravel-backup/releases/tag/10.3.0), 1 week ago) - A package to backup your Laravel app
