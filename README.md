...
- [thecaliskan/laravel-stock](https://github.com/thecaliskan/laravel-stock) ([1.1.0](https://github.com/thecaliskan/laravel-stock/releases/tag/1.1.0), 2 days ago) - Laravel Stock, Forex, Crypto Data API
- [spatie/mailcoach-mailer](https://github.com/spatie/mailcoach-mailer) ([1.2.0](https://github.com/spatie/mailcoach-mailer/releases/tag/1.2.0), 2 days ago) - The Mailcoach transport for Symfony Mailer
- [dompdf/dompdf](https://github.com/dompdf/dompdf) ([v2.0.8](https://github.com/dompdf/dompdf/releases/tag/v2.0.8), 5 days ago) - HTML to PDF converter for PHP
- [spatie/holidays](https://github.com/spatie/holidays) ([1.10.0](https://github.com/spatie/holidays/releases/tag/1.10.0), 5 days ago) - Calculate which days you don&#39;t have to work!
