...
- [spatie/browsershot](https://github.com/spatie/browsershot) ([5.2.3](https://github.com/spatie/browsershot/releases/tag/5.2.3), today) - Convert HTML to an image, PDF or string
