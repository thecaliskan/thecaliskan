...
- [thecaliskan/proxy-api](https://github.com/thecaliskan/proxy-api) ([v1.1.0](https://github.com/thecaliskan/proxy-api/releases/tag/v1.1.0), 1 day ago) - Proxy API for HTTP Request
- [spatie/global-ray](https://github.com/spatie/global-ray) ([1.2.3](https://github.com/spatie/global-ray/releases/tag/1.2.3), 3 days ago) - Enable Ray in all PHP files on your system
- [spatie/laravel-health](https://github.com/spatie/laravel-health) ([1.34.10](https://github.com/spatie/laravel-health/releases/tag/1.34.10), 4 days ago) - Check the health of your Laravel app
- [spatie/browsershot](https://github.com/spatie/browsershot) ([5.2.0](https://github.com/spatie/browsershot/releases/tag/5.2.0), 4 days ago) - Convert HTML to an image, PDF or string
- [spatie/phpunit-watcher](https://github.com/spatie/phpunit-watcher) ([1.24.2](https://github.com/spatie/phpunit-watcher/releases/tag/1.24.2), 4 days ago) - A tool to automatically rerun PHPUnit tests when source code changes

#### 👷 Check out what I'm currently working on

- [laravel/horizon](https://github.com/laravel/horizon) - Dashboard and code-driven configuration for Laravel queues. (1 day ago)
- [thecaliskan/proxy-api](https://github.com/thecaliskan/proxy-api) - Proxy API for HTTP Request (1 day ago)
