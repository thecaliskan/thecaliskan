...
- [laravel/horizon](https://github.com/laravel/horizon) ([v5.47.0](https://github.com/laravel/horizon/releases/tag/v5.47.0), 2 days ago) - Dashboard and code-driven configuration for Laravel queues.
- [spatie/laravel-flare](https://github.com/spatie/laravel-flare) ([3.0.0-rc.3](https://github.com/spatie/laravel-flare/releases/tag/3.0.0-rc.3), 2 days ago) - Send Laravel errors to Flare
- [spatie/flare-client-php](https://github.com/spatie/flare-client-php) ([3.0.0-rc.3](https://github.com/spatie/flare-client-php/releases/tag/3.0.0-rc.3), 2 days ago) - Send PHP errors to Flare
