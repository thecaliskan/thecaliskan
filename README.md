...
- [swoole/swoole-src](https://github.com/swoole/swoole-src) ([v6.1.10](https://github.com/swoole/swoole-src/releases/tag/v6.1.10), 1 day ago) - 🚀 Coroutine-based concurrency library for PHP
- [spatie/laravel-backup](https://github.com/spatie/laravel-backup) ([10.3.3](https://github.com/spatie/laravel-backup/releases/tag/10.3.3), 2 days ago) - A package to backup your Laravel app
- [spatie/laravel-medialibrary](https://github.com/spatie/laravel-medialibrary) ([11.23.8](https://github.com/spatie/laravel-medialibrary/releases/tag/11.23.8), 2 days ago) - Associate files with Eloquent models
