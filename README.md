...
- [spatie/db-dumper](https://github.com/spatie/db-dumper) ([3.8.3](https://github.com/spatie/db-dumper/releases/tag/3.8.3), 1 day ago) - Dump the contents of a database
- [spatie/phpunit-watcher](https://github.com/spatie/phpunit-watcher) ([1.24.4](https://github.com/spatie/phpunit-watcher/releases/tag/1.24.4), 1 day ago) - A tool to automatically rerun PHPUnit tests when source code changes
- [spatie/laravel-medialibrary](https://github.com/spatie/laravel-medialibrary) ([11.17.8](https://github.com/spatie/laravel-medialibrary/releases/tag/11.17.8), 1 day ago) - Associate files with Eloquent models
- [php/pie](https://github.com/php/pie) ([1.3.4](https://github.com/php/pie/releases/tag/1.3.4), 4 days ago) - The PHP Installer for Extensions
- [symfony/http-foundation](https://github.com/symfony/http-foundation) ([v8.0.3](https://github.com/symfony/http-foundation/releases/tag/v8.0.3), 6 days ago) - Defines an object-oriented layer for the HTTP specification
