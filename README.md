...
- [laravel/horizon](https://github.com/laravel/horizon) ([v5.47.2](https://github.com/laravel/horizon/releases/tag/v5.47.2), 2 days ago) - Dashboard and code-driven configuration for Laravel queues.
- [spatie/laravel-backup](https://github.com/spatie/laravel-backup) ([10.2.2](https://github.com/spatie/laravel-backup/releases/tag/10.2.2), 4 days ago) - A package to backup your Laravel app
- [spatie/emoji](https://github.com/spatie/emoji) ([4.1.3](https://github.com/spatie/emoji/releases/tag/4.1.3), 6 days ago) - Programatically work with emoji characters
