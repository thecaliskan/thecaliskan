...
- [dompdf/dompdf](https://github.com/dompdf/dompdf) ([v3.0.1](https://github.com/dompdf/dompdf/releases/tag/v3.0.1), 3 days ago) - HTML to PDF converter for PHP
- [spatie/ray](https://github.com/spatie/ray) ([1.41.3](https://github.com/spatie/ray/releases/tag/1.41.3), 6 days ago) - Debug with Ray to fix problems faster
- [spatie/crawler](https://github.com/spatie/crawler) ([8.3.0](https://github.com/spatie/crawler/releases/tag/8.3.0), 6 days ago) - An easy to use,  powerful crawler implemented in PHP. Can execute Javascript.
