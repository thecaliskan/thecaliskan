...
- [composer/ca-bundle](https://github.com/composer/ca-bundle) ([1.5.1](https://github.com/composer/ca-bundle/releases/tag/1.5.1), today) - Lets you find a path to the system CA bundle, and includes a fallback to the Mozilla CA bundle.
- [spatie/browsershot](https://github.com/spatie/browsershot) ([4.1.1](https://github.com/spatie/browsershot/releases/tag/4.1.1), 5 days ago) - Convert HTML to an image, PDF or string
...
- [spatie/global-ray](https://github.com/spatie/global-ray) ([1.1.2](https://github.com/spatie/global-ray/releases/tag/1.1.2), 1 month ago) - Enable Ray in all PHP files on your system
