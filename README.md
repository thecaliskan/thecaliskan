...
- [php/php-windows-builder](https://github.com/php/php-windows-builder) ([1.1.7](https://github.com/php/php-windows-builder/releases/tag/1.1.7), today) - Tooling to build PHP and extensions on Windows
- [Laravel-Lang/lang](https://github.com/Laravel-Lang/lang) ([15.24.1](https://github.com/Laravel-Lang/lang/releases/tag/15.24.1), 1 day ago) - List of 127 languages for Laravel Framework, Laravel Jetstream, Laravel Fortify, Laravel Breeze, Laravel Cashier, Laravel Nova and Laravel UI.
- [php/pie](https://github.com/php/pie) ([1.2.0](https://github.com/php/pie/releases/tag/1.2.0), 1 day ago) - The PHP Installer for Extensions
- [symfony/http-foundation](https://github.com/symfony/http-foundation) ([v7.3.3](https://github.com/symfony/http-foundation/releases/tag/v7.3.3), 5 days ago) - Defines an object-oriented layer for the HTTP specification
