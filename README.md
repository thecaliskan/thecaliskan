...
- [Laravel-Lang/lang](https://github.com/Laravel-Lang/lang) ([15.23.1](https://github.com/Laravel-Lang/lang/releases/tag/15.23.1), 3 days ago) - List of 127 languages for Laravel Framework, Laravel Jetstream, Laravel Fortify, Laravel Breeze, Laravel Cashier, Laravel Nova and Laravel UI.
- [php/php-windows-builder](https://github.com/php/php-windows-builder) ([1.1.6](https://github.com/php/php-windows-builder/releases/tag/1.1.6), 6 days ago) - Tooling to build PHP and extensions on Windows
...
- [symfony/http-foundation](https://github.com/symfony/http-foundation) ([v7.3.2](https://github.com/symfony/http-foundation/releases/tag/v7.3.2), 3 weeks ago) - Defines an object-oriented layer for the HTTP specification
