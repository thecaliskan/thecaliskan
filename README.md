...
- [spatie/crawler](https://github.com/spatie/crawler) ([8.2.1](https://github.com/spatie/crawler/releases/tag/8.2.1), today) - An easy to use,  powerful crawler implemented in PHP. Can execute Javascript.
- [spatie/browsershot](https://github.com/spatie/browsershot) ([4.1.3](https://github.com/spatie/browsershot/releases/tag/4.1.3), 1 day ago) - Convert HTML to an image, PDF or string
