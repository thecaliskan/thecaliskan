...
- [spatie/typescript-transformer](https://github.com/spatie/typescript-transformer) ([3.0.0-beta.1](https://github.com/spatie/typescript-transformer/releases/tag/3.0.0-beta.1), 2 days ago) - Transform PHP types to TypeScript
- [laravel/horizon](https://github.com/laravel/horizon) ([v5.43.0](https://github.com/laravel/horizon/releases/tag/v5.43.0), 3 days ago) - Dashboard and code-driven configuration for Laravel queues.
- [spatie/laravel-flare](https://github.com/spatie/laravel-flare) ([2.7.0](https://github.com/spatie/laravel-flare/releases/tag/2.7.0), 4 days ago) - Send Laravel errors to Flare
- [spatie/flare-client-php](https://github.com/spatie/flare-client-php) ([2.10.0](https://github.com/spatie/flare-client-php/releases/tag/2.10.0), 6 days ago) - Send PHP errors to Flare
- [php/php-windows-builder](https://github.com/php/php-windows-builder) ([1.6.1](https://github.com/php/php-windows-builder/releases/tag/1.6.1), 6 days ago) - Tooling to build PHP and extensions on Windows
