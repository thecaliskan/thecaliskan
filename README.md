...
- [laravel/horizon](https://github.com/laravel/horizon) ([v5.50.0](https://github.com/laravel/horizon/releases/tag/v5.50.0), 2 days ago) - Dashboard and code-driven configuration for Laravel queues.
- [swoole/swoole-src](https://github.com/swoole/swoole-src) ([v6.2.3](https://github.com/swoole/swoole-src/releases/tag/v6.2.3), 2 days ago) - 🚀 Coroutine-based concurrency library for PHP
- [spatie/emoji](https://github.com/spatie/emoji) ([4.2.0](https://github.com/spatie/emoji/releases/tag/4.2.0), 6 days ago) - Programatically work with emoji characters
