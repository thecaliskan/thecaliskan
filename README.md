...
- [spatie/mjml-php](https://github.com/spatie/mjml-php) ([1.2.0](https://github.com/spatie/mjml-php/releases/tag/1.2.0), 4 days ago) - Convert MJML to HTML using PHP
- [composer/ca-bundle](https://github.com/composer/ca-bundle) ([1.5.1](https://github.com/composer/ca-bundle/releases/tag/1.5.1), 5 days ago) - Lets you find a path to the system CA bundle, and includes a fallback to the Mozilla CA bundle.
