...
- [php/php-windows-builder](https://github.com/php/php-windows-builder) ([1.1.4](https://github.com/php/php-windows-builder/releases/tag/1.1.4), 1 day ago) - Tooling to build PHP and extensions on Windows
- [Laravel-Lang/lang](https://github.com/Laravel-Lang/lang) ([15.22.8](https://github.com/Laravel-Lang/lang/releases/tag/15.22.8), 4 days ago) - List of 127 languages for Laravel Framework, Laravel Jetstream, Laravel Fortify, Laravel Breeze, Laravel Cashier, Laravel Nova and Laravel UI.
- [php/pie](https://github.com/php/pie) ([1.1.0](https://github.com/php/pie/releases/tag/1.1.0), 6 days ago) - The PHP Installer for Extensions
