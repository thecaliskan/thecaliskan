...
- [Laravel-Lang/lang](https://github.com/Laravel-Lang/lang) ([15.22.6](https://github.com/Laravel-Lang/lang/releases/tag/15.22.6), today) - List of 127 languages for Laravel Framework, Laravel Jetstream, Laravel Fortify, Laravel Breeze, Laravel Cashier, Laravel Nova and Laravel UI.
- [php/php-src](https://github.com/php/php-src) ([php-8.3.24](https://github.com/php/php-src/releases/tag/php-8.3.24), 1 day ago) - The PHP Interpreter
- [php/pie](https://github.com/php/pie) ([1.1.0-rc.1](https://github.com/php/pie/releases/tag/1.1.0-rc.1), 2 days ago) - The PHP Installer for Extensions
- [symfony/http-foundation](https://github.com/symfony/http-foundation) ([v7.3.2](https://github.com/symfony/http-foundation/releases/tag/v7.3.2), 6 days ago) - Defines an object-oriented layer for the HTTP specification
