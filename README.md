...
- [spatie/laravel-backup](https://github.com/spatie/laravel-backup) ([10.3.2](https://github.com/spatie/laravel-backup/releases/tag/10.3.2), today) - A package to backup your Laravel app
- [spatie/image](https://github.com/spatie/image) ([3.9.6](https://github.com/spatie/image/releases/tag/3.9.6), 2 days ago) - https://spatie.be/docs/image/v3/introduction
- [spatie/laravel-backup-server](https://github.com/spatie/laravel-backup-server) ([4.3.1](https://github.com/spatie/laravel-backup-server/releases/tag/4.3.1), 3 days ago) - Backup multiple servers
- [spatie/holidays](https://github.com/spatie/holidays) ([2.5.0](https://github.com/spatie/holidays/releases/tag/2.5.0), 3 days ago) - Calculate which days you don&#39;t have to work!
