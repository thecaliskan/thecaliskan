...
- [spatie/lighthouse-php](https://github.com/spatie/lighthouse-php) ([1.2.2](https://github.com/spatie/lighthouse-php/releases/tag/1.2.2), 2 days ago) - Run Google Lighthouse using PHP
- [thecaliskan/laravel-stock](https://github.com/thecaliskan/laravel-stock) ([1.1.0](https://github.com/thecaliskan/laravel-stock/releases/tag/1.1.0), 6 days ago) - Laravel Stock, Forex, Crypto Data API
- [spatie/mailcoach-mailer](https://github.com/spatie/mailcoach-mailer) ([1.2.0](https://github.com/spatie/mailcoach-mailer/releases/tag/1.2.0), 6 days ago) - The Mailcoach transport for Symfony Mailer
