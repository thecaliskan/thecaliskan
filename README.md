...
- [dunglas/frankenphp](https://github.com/dunglas/frankenphp) ([v1.3.2](https://github.com/dunglas/frankenphp/releases/tag/v1.3.2), today) - 🧟 The modern PHP app server
- [spatie/db-dumper](https://github.com/spatie/db-dumper) ([3.7.1](https://github.com/spatie/db-dumper/releases/tag/3.7.1), 5 days ago) - Dump the contents of a database
