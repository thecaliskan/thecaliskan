...
- [php/php-src](https://github.com/php/php-src) ([php-8.4.14](https://github.com/php/php-src/releases/tag/php-8.4.14), 1 day ago) - The PHP Interpreter
- [spatie/lighthouse-php](https://github.com/spatie/lighthouse-php) ([2.0.0](https://github.com/spatie/lighthouse-php/releases/tag/2.0.0), 4 days ago) - Run Google Lighthouse using PHP
...
- [spatie/spatie.be](https://github.com/spatie/spatie.be) - The source code of spatie.be (3 days ago)
- [spatie/lighthouse-php](https://github.com/spatie/lighthouse-php) - Run Google Lighthouse using PHP (3 days ago)
