...
- [composer/ca-bundle](https://github.com/composer/ca-bundle) ([1.5.4](https://github.com/composer/ca-bundle/releases/tag/1.5.4), 3 days ago) - Lets you find a path to the system CA bundle, and includes a fallback to the Mozilla CA bundle.
- [spatie/browsershot](https://github.com/spatie/browsershot) ([5.0.0](https://github.com/spatie/browsershot/releases/tag/5.0.0), 5 days ago) - Convert HTML to an image, PDF or string
