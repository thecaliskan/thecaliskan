...
- [spatie/holidays](https://github.com/spatie/holidays) ([1.15.0](https://github.com/spatie/holidays/releases/tag/1.15.0), 1 day ago) - Calculate which days you don&#39;t have to work!
- [spatie/server-side-rendering](https://github.com/spatie/server-side-rendering) ([0.4.0](https://github.com/spatie/server-side-rendering/releases/tag/0.4.0), 2 days ago) - Server side rendering JavaScript in a PHP application
- [spatie/ssh](https://github.com/spatie/ssh) ([1.11.0](https://github.com/spatie/ssh/releases/tag/1.11.0), 2 days ago) - A lightweight package to execute commands over an SSH connection
